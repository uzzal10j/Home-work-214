        ...
        bill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (myunit.length()>=0){
                    ...
                    else if (mainbill<=125) total_bill = (float) (314.25+(mainbill-75)*5.72);
                    else if (mainbill<=300) total_bill = (float) (314.25+715+(mainbill-200)*6.00);
                    else if (mainbill<=400) total_bill = (float) (314.25+715+600+(mainbill-300)*6.34);
                    else if (mainbill<=600) total_bill = (float) (314.25+715+600+634+(mainbill-400)*9.94);
                    else total_bill = (float) (314.25+715+600+634+1988+(mainbill-600)*9.94);
